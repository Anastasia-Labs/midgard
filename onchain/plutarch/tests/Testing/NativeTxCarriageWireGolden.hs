...
tests =
  testGroup
    ...
    , testCase "golden_certificate_missing_field_hash_parses_as_cbor" $
        passertEval $ parses certificateMissingFieldHashCbor
    , testCase "golden_certificate_missing_field_hash_rejects" $
        rejects certificateSchema certificateMissingFieldHashCbor
...
certificateSchema value = forceConstructor value [(0, [BytesField, BytesField, IntegerField, BytesField, IntegerField, ByteListField])]
...
certificateCorner =
  pcon $
    PFieldPreimageCertificateV1
      ...
      , pcert'fieldHash = pdata (pconstant $ BS.replicate 32 0x66)
...
certificateCornerCbor = hex ""
...
certificateTrailingBytesCbor, certificateMissingDigestsCbor, certificateMissingFieldHashCbor, certificateFieldIndexAsBytesCbor :: BS.ByteString
certificateTrailingBytesCbor = hex ""
certificateMissingDigestsCbor = hex "d8799f581c11111111111111111111111111111111111111111111111111111111582022222222222222222222222222222222222222222222222222222222222222220558206666666666666666666666666666666666666666666666666666666666666666197ffbff"
certificateMissingFieldHashCbor = hex ""
certificateFieldIndexAsBytesCbor = hex ""
