  ...
  testGroup
    ...
    , testGroup
        ...
        , testCase "releases an order recorded with a failed script" $
            psucceeds $
              runSpend defaults{sClaimed = txFailedScript, sCommitted = txFailedScript}
