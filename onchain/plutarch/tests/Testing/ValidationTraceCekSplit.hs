...
import Midgard.CekContextChain qualified as Context
                ...
                ( pdata $
                    pcon $
                        Selection.PAction
                            ...
                            (pdata 2)
                            transition
                            (pforgetData auxiliary)
                            materialRoute
                            (pdata $ pcons # pdata 6 # pnil)
                            (pdata $ pcon $ Proof.PProgramEnvelopeV1 (pdata $ pconstant "") (pdata 7) (pdata 8))
                            (pdata $ pcon $ Proof.PCekMaterialPartitionFacts (pdata 9) (pdata 10) (pdata 11) (pdata 12) (pdata pnil) (pdata pnil))
                            (pdata $ pconstant False)
                )
                #== pconstant (PD.Constr 0 [PD.I 1, PD.I 2, PD.I 3, PD.I 4, PD.I 5, PD.List [PD.I 6], PD.Constr 0 [PD.B "", PD.I 7, PD.I 8], PD.Constr 0 [PD.I 9, PD.I 10, PD.I 11, PD.I 12, PD.List [], PD.List []], PD.Constr 0 []])
            , pforgetData
                (pdata $ pcon $ Context.PAction (pdata 1) (pdata 2) transition (pforgetData auxiliary))
                #== pconstant (PD.Constr 0 [PD.I 1, PD.I 2, PD.I 3, PD.I 4])
            , pforgetData
                (pdata $ pcon $ Core.PCoreAction (pdata 1) (pdata 2) transition (pforgetData coreStep))
                #== pconstant (PD.Constr 0 [PD.I 1, PD.I 2, PD.I 3, PD.I 4])
            ]
