...
8. **Finality is depth- and chain-point-based.** Acceptance mode declares
   ...
   below that depth, and an incident state after finalized rollback. W10–W14
...
| W13 | Rollback engine                        | W10–W12    | Rewinds pending observations, decisions, DA associations, reconstructed states, and submissions deterministically; post-finality rollback becomes explicit incident state.                                                                                                                                                                                                                        |
...
| W44 | Crash/rollback matrix              | W32–W43       | Crash before/after every submit/confirm/journal transition plus L1 rollback/configured-source inconsistency; no double submit, lost evidence, false verified state, or stuck unrecoverable workflow.                                                                                                |
