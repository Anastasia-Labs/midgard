...
The data-availability payload for this body is \code{DaPayloadBodyV2}. It includes the embedded header, the header hash, all body member arrays above, and the count fields repeated from the header.
