...
members, event-to-step members, validation-trace descriptors, and counts.
Committee nodes recompute every root and count against the L1 header before signing an attestation.
