...
Historical data outside live protocol obligations is an archival service. Current recovery and challenge workflows still require authenticated retained DA and relevant L1 publication history; the archive proposal does not authorize deleting those records. However, we expect it to be stored to the extent that users are willing to pay for this service.
