...
Reference scripts are supported in canonical V1. A reference script contained in a
ledger output shares that output preimage's concrete membership-proof
envelope; when a script program is revealed by a script-execution instruction,
it also satisfies that instruction's program-preimage envelope. There is no
zero-byte canonical V1 limit.
