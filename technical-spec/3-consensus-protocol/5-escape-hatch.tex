...
\paragraph{Implementation status.} This section specifies a proposed emergency mechanism. The current validator inventory contains no escape-hatch validator, and registration enforces the ordinary required bond. Reduced-bond registration, emergency timing, and the grace-period lifecycle below must not be treated as deployed or implemented behavior.
