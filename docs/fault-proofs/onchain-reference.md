...
| --------------------------- | -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `zero-input`                | 2                    | native counted-root membership in step 01; `bad_tx_spend_inputs_hash == blake2b_256(encode_native_byte_list([]))` (`zero-input/step-02.ak:20-28,83-86`). This deliberately does not use the PlutusData `env.empty_list_hash`. |
...
| `validators/fraud-proofs/zero-input/step-02.ak:98-215`                           | 5     | native empty-list encoding/literal, non-empty inequality, and direct full-handler accept/reject fixtures                                                                                                                |
