...
cd ../../demo && pnpm --filter @al-ft/midgard-fault-proofs test -- tests/submit-init-emulator-script-sources-output-proof-v1.test.ts tests/validation-dispute-submit.test.ts
```
