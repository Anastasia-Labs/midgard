...
cd ../../demo && pnpm --filter @al-ft/midgard-fault-proofs test -- tests/validation-dispute-submit.test.ts tests/submit-init-emulator-script-sources-stage-one-v1.test.ts
```
