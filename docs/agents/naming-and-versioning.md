...
in wire, storage, or manifest values. Qualify names when the distinction matters,
such as demo or test variants. Preserve external names and pinned evidence paths.
