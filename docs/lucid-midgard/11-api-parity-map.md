...
| `partialSign.withWalletProgram`                | midgard-only   | Lazy `Effect` wrapper for detached witness bundles.                                                 |
...
| `partialSign.withPrivateKeyProgram`            | midgard-only   | Lazy `Effect` wrapper for detached witness bundles.                                                 |
...
| `partialSign.withExternalSignerProgram`        | midgard-only   | Lazy `Effect` wrapper for external body-hash signer bundles.                                        |
