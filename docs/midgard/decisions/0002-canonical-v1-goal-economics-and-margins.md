...
| Parameter                                                        | Value                                                                                                                                                                                                                      | Rationale                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ---------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `finalityDepth` (local_node and external_providers)              | 30 blocks (~10 min Preprod) — **ACCEPTED** for testing and, conditionally, for public launch                                                                                                                               | Within watcher config bounds (1–2,160). It governs anchoring only: the finalized audit anchor of a completed workflow, incident records, and evidence stamps. The public-launch acceptance is conditional on the automated deep-rollback requirement below.                                                                                                                                                                    |
| Fault-proof action inclusion                                     | 1 block — fixed runtime behavior                                                                                                                                                                                           | Fault-proof actions use authenticated inclusion: once a step is included, the next step can be built and submitted under fresh authority. There is no configurable action-depth field. This does not change `finalityDepth`, the release finality policy, or the manifest digest.                                                                                                                                              |
