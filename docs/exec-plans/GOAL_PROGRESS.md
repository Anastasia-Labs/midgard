...
| F04             | F03               | parent owner-decision integration | `docs/midgard/decisions/0002-canonical-v1-goal-economics-and-margins.md` | PASS | `58f03c55` | Fully ACCEPTED 2026-08-04 and implemented in the current profiles. Public Preprod economics are P/R/I/B = 25,000/75,000/10,000/100,000 ADA; the testnet profile is 500/400/100/900 ADA. Validators and builders enforce exact bond conservation, immutable fraud-prover enterprise-address reward routing and signature, fee composition after inactivity slash, singleton claim-lock lifecycle, and zero duplicate rewards. Current release work is live balance-conservation and concurrent-claim acceptance, not zero-value replacement. W31/C74/C80 may raise funding/cost floors but may not silently alter the accepted profiles. |
