...
| L16 | Ledger output preimage and compact commitment                                | nested-schema | `LedgerOutputCommitmentV1`; full output CBOR remains in DA and persistence   | Ledger MPF value and bounded full-output proof opening        | TS/Aiken descriptor encode/decode/root vectors   |
