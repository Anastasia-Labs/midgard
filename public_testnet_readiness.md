...
- [ ] Complete the public fraud-proof/proof-data-availability milestone.
  ...
  - Prerequisite: deploy only the current generated testnet identity. The
    blueprint contains 510 validators and has SHA-256
    `ad69e8f98e49e110864cb270dd6bb731caaf43357e8459827b1659124c890de8`.
    The 29-category source catalogue derives root
    `c686373893084eff5efe51a52821055f994caa4c26a363df37ec97df23380b62`.
    The inspection suite still pins the older root, so release identity checks
    are not green yet. The authenticated field-carriage and
    empty-trie-sentinel repairs are in the current source. Do not deploy an
    older catalogue identity as a substitute.
...
| `docs/fault-proofs/coverage-matrix.md` and `catalogue-status.md` record the remaining standalone-family, autonomous-watcher, proof-data, economics, and live/preprod gaps.                                                                                                                                                                                                                                                                                     | Public security claims must be narrowed and enabled features gated until the proof matrix and operational acceptance are complete.                                                          |
