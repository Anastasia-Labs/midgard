      ...
      parserOptions: {
        projectService: {
          allowDefaultProject: [
            ...
            "midgard-manager/packages/cli/scripts/copy-package-json.ts",
            "midgard-manager/packages/cli/tsup.config.ts",
            "midgard-manager/packages/tx-generator/tests/generate.test.ts",
            "midgard-manager/packages/tx-generator/tests/generators.test.ts",
            "midgard-manager/packages/tx-generator/tests/node-client.test.ts",
            "midgard-manager/packages/tx-generator/tests/setup.ts",
            "midgard-manager/packages/tx-generator/tests/utils.test.ts",
            "midgard-manager/packages/tx-generator/vitest.config.ts",
