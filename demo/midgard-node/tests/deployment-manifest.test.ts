...
describe("V1 deployment manifest", () => {
  it("delegates canonical JSON normalization and digesting to core", () => {
    ...
    expect(DEPLOYMENT_MANIFEST_CONTRACT_NAMES).toHaveLength(319);
    expect(DEPLOYMENT_MANIFEST_REFERENCE_SCRIPT_ROLES).toHaveLength(312);
    expect(Object.keys(REFERENCE_SCRIPT_AUTH_TOKEN_NAMES)).toHaveLength(313);
