CREATE TABLE address_history (
  ...
  CONSTRAINT unique_address_history UNIQUE (tx_id, address)
);
...
CREATE TABLE blocks (
  ...
  tx_id BYTEA NOT NULL CONSTRAINT unique_blocks_tx_id UNIQUE,
...
CREATE TABLE pending_block_finalizations (
  ...
  submitted_tx_hash BYTEA CONSTRAINT unique_pending_block_finalizations_submitted_tx_hash UNIQUE,
...
CREATE TABLE pending_block_finalization_deposits (
  ...
  CONSTRAINT unique_pending_block_finalization_deposit_ordinal UNIQUE (header_hash, ordinal)
);
...
CREATE TABLE pending_block_finalization_txs (
  ...
  ordinal INTEGER NOT NULL,
  PRIMARY KEY (header_hash, member_id),
  CONSTRAINT unique_pending_block_finalization_tx_ordinal UNIQUE (header_hash, ordinal)
);
