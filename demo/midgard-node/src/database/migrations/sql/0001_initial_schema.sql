...
CREATE TABLE public.da_payloads (
    ...
    consensus_profile_id text DEFAULT 'midgard-consensus-v1'::text NOT NULL,
...
CREATE TABLE public.foreign_tip_reconciliations (
    ...
    CONSTRAINT foreign_tip_reconciliations_check1 CHECK ((((verified_da_payload_cbor IS NULL) AND (verified_da_schema_version IS NULL)) OR ((verified_da_payload_cbor IS NOT NULL) AND (verified_da_schema_version = 1)))),
...
CREATE TABLE public.pending_block_finalizations (
    ...
    consensus_profile_id text DEFAULT 'midgard-consensus-v1'::text NOT NULL,
    expected_validation_traces_root text DEFAULT '0e5751c026e543b2e8ab2eb06099daa1d1e5df47778f7787faab45cdf12fe3a8'::text NOT NULL,
    expected_validation_trace_count bigint DEFAULT 0 NOT NULL,
