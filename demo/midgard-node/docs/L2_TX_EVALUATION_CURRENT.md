...
| ------------------------- | ---------------------------------- |
| `spend_inputs_hash`       | `spend_inputs_preimage_cbor`       |
| `reference_inputs_hash`   | `reference_inputs_preimage_cbor`   |
| `outputs_hash`            | `outputs_preimage_cbor`            |
| `required_observers_hash` | `required_observers_preimage_cbor` |
