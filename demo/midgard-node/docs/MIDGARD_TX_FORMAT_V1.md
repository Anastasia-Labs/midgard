...
- `MidgardTxBodyCompactV1`
  ...
  - `[spend_inputs_hash, reference_inputs_hash, outputs_hash, fee, valid_from, valid_to, required_observers_hash, required_signers_hash, mint_hash, script_integrity_hash, auxiliary_data_hash, network_id]`
