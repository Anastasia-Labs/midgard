 ...
 * nothing: the canonical bounded-collection commitment for field zero with no
 * items. Derived from the same codec that commits real input preimages, so it
 * cannot drift from the `empty_spend_inputs_hash` constant the step-02
