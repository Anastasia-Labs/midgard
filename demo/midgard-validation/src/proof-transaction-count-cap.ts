 ...
 * capability-parity.ts's `maxTxExecutionMemoryUnits`, pinned to
 * `"16500000"` in capability-parity.test.ts:49). §3.3 "Execution fit"
 ...
 * complete-item-proof-fit-emulator.test.ts:84-89 as
