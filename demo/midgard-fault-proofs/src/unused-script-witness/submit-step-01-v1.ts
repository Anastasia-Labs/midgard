...
import { classifyUnusedScriptWitnessFinding } from "./family-v1.js";
import {
...
export const submitUnusedScriptWitnessStep01Accepted = async ({
  lucid,
  blueprint,
  network,
  contracts,
  ...
  const nextDatum = Data.to(
    ...
    UnusedScriptStep02DatumSchema as never,
  );
  return await submitMissingNativeScriptTxBinding({
    ...
    txInclusion,
    nextDatum,
    spendRedeemerSchema: UnusedScriptStep01RedeemerSchema,
...
export const submitUnusedScriptWitnessStep01Forced = async ({
  lucid,
  contracts,
  categoryId,
  signer,
  ...
  const redeemer = ((ctx) => {
    ...
    return Data.to(
      ...
      UnusedScriptStep01RedeemerSchema as never,
    );
