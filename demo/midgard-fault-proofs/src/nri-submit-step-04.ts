...
export type NriSubmitStep04CliConfig = SubmitProviderConfig & {
...
export type NriSubmitStep04Result = {
...
export const nriSubmitStep04 = async ({
  lucid,
  blueprint,
  deploymentInfo,
  network,
...
export const nriSubmitStep04FromFiles = async (
  config: NriSubmitStep04CliConfig,
): Promise<NriSubmitStep04Result> => {
