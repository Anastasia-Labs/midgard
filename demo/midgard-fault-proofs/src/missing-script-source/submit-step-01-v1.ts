...
import {
  ...
  type MissingScriptSourceFinding,
} from "./family-v1.js";
import {
...
const boundState = ({
  ...
  subject: MissingScriptSourceFinding["subject"];
  header: Header;
  purposeKind: 0 | 1 | 2 | 3;
  purposeIndex: bigint;
...
export const submitMissingScriptSourceStep01Accepted = async ({
  lucid,
  blueprint,
  network,
  contracts,
  ...
  const finding = classifyMissingScriptSourceFinding({
    subject,
    purposeKind,
...
export const submitMissingScriptSourceStep01Forced = async ({
  lucid,
  contracts,
  categoryId,
  signer,
