...
export type PreparedWithdrawnInputEvidence = {
  readonly schemaVersion: typeof WITHDRAWN_INPUT_EVIDENCE_SCHEMA_VERSION;
...
export class WithdrawnInputEvidenceRejection extends Error {
  constructor(
    readonly code:
...
export const withdrawnInputEvidenceReject = (
  code: WithdrawnInputEvidenceRejection["code"],
  detail: string,
): never => {
  throw new WithdrawnInputEvidenceRejection(code, detail);
};
