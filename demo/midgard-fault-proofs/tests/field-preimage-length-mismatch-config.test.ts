...
vi.mock(
  "../src/field-preimage-length-mismatch/evidence.js",
  async (importOriginal) => {
    const original =
      await importOriginal<
        typeof import("../src/field-preimage-length-mismatch/evidence.js")
      >();
    return {
      ...original,
...
} from "../src/field-preimage-length-mismatch/config.js";
import { detectAuthenticatedFieldPreimageLengthEvidence } from "../src/field-preimage-length-mismatch/evidence.js";
import type {
