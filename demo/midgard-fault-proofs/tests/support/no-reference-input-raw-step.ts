...
import {
  type NoReferenceInputForcedContracts,
  noReferenceInputForcedFieldPlan,
  noReferenceInputForcedStates,
...
export const submitRawNoReferenceInputForcedStep = async ({
  lucid,
  contracts,
  categoryId,
  signer,
  ...
  const redeemer = ((ctx) => {
    ...
    const schema = [
      SDK.NoReferenceInputStep01SpendRedeemer,
