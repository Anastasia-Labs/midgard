...
import { createSpendInputSignerMissingCentralJournalAdapterV1 } from "../src/spend-input-signer-missing/central-journal-v1.js";
import type {
...
const adapter = (
  ...
  createSpendInputSignerMissingCentralJournalAdapterV1({
    store: value,
