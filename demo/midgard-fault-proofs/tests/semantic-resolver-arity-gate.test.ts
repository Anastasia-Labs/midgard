...
describe("zz609 the arity check is the only door", () => {
  ...
  it("confines bare compiledCode reads to the allowlisted loaders (#610)", () => {
    ...
    const allowedReaders = [
      ...
      "demo/midgard-fault-proofs/tests/native-script-decoding-envelope.test.ts",
      ...
      "demo/midgard-fault-proofs/tests/semantic-resolver-arity-gate.test.ts",
      ...
      "demo/midgard-fault-proofs/tests/compiled-script-arity-gate.test.ts",
    ].sort();
