...
import { INPUT_SET_UNIQUENESS_WRONGFUL_REJECTION_VIOLATION_ID_V1 } from "../src/input-set-uniqueness/replay-v1.js";
import { buildCountedRoot } from "../src/transition-trace/phas.js";
import {
  admitProductionInputSetUniquenessForcedArtifactV1,
  InputSetUniquenessForcedSourceV1Schema,
...
const makeArtifact = async () => {
  ...
  return {
    ...
    detectionId: `${INPUT_SET_UNIQUENESS_WRONGFUL_REJECTION_VIOLATION_ID_V1}:forced:0:${fixture.nativeTxId}`,
    position: 0,
    forcedIndex: 0,
    transactionId: fixture.nativeTxId,
    subjectCbor: Data.to(
...
describe("production input-set-uniqueness forced authority", () => {
  ...
  it("keeps manifest-bound configuration infrastructure-only", () => {
    type Keys = keyof ManifestBoundInputSetUniquenessWorkflowConfigV1;
