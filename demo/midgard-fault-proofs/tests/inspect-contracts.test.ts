...
// `102ef380…`.
// Re-pinned 2026-09-05 (Wave 4, `executionSourceScriptDecoding`): the same
// two engine-pattern fixes (empty-payload bind close, window authentication
...
// Re-pinned 2026-09-05 (`witnessScriptDecoding` integration): step 02's
// empty-payload classification and step 03's authenticated scan change the
