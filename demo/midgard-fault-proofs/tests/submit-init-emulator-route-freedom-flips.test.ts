 ...
 *
 * Split from `submit-init-emulator-route-freedom-recovery.test.ts`. The split
 * was made while `@lucid-evolution/uplc` (through 0.2.22) leaked wasm linear
...
describe("route freedom: build-time delivery flips (#621)", () => {
