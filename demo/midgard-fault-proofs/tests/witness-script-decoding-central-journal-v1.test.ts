...
import { createWitnessScriptDecodingCentralJournalAdapter } from "../src/witness-script-decoding/central-journal-v1.js";
import type {
...
const adapter = (
  ...
  createWitnessScriptDecodingCentralJournalAdapter({
    store: value,
