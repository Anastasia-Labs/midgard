...
vi.mock("../src/workflow/deployment-manifest-binding.js", () => ({
...
vi.mock("../src/workflow/family-l1-observation.js", () => ({
  createFraudProofFamilyLocalKupmiosL1ObservationPort: mocks.createL1,
}));
vi.mock("../src/script-integrity-hash-mismatch/lucid-actuator.js", () => ({
