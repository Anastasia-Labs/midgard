...
vi.mock(
  "../src/script-integrity-hash-mismatch/retained-stage-three.js",
  () => ({
...
import { detectScriptIntegrityHashMismatchCanonicalViolations } from "../src/script-integrity-hash-mismatch/replay.js";
