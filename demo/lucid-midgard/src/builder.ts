...
// Wire-format boundary (midgard-ts binary <-> internal `MidgardNativeTxFull`)
// lives in `@al-ft/midgard-validation/native-tx-bridge` and is imported above
// (`encodeMidgardTxBytes`, `decodeMidgardTxBytes`, `midgardTxIdFromFull`,
// `nativeFullToMidgardTs`). Phase-a / phase-b use the same bridge for decoding.
